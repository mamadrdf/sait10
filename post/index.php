...
<div class="row">
    ...
    <div class="col-md-12 comment mb-3 mt-3 pt-3">
        <div class="media g-mb-30 media-comment">
            <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15 mr-3" width="50" height="50" src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="Image Description">
            <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
              <div class="g-mb-15">
                <h5 class="h5 g-color-gray-dark-v1 mb-0">مهدی اباذری</h5>
                <span class="g-color-gray-dark-v4 g-font-size-12">5 روز پیش</span>
              </div>
